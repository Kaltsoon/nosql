...
- During this course, we will learn the principles of NoSQL DBMS, how they differ from relational database management systems and what their benefits, challenges
...
## MongoDB — Scalable, flexible, document-based
...
- The JSON-like documents **don't have a fixed schema** (e.g. predefined attribute names and data-types), which makes it easy to evolve the structure
...
```shell
SET teacher:h02680 "Kalle;Ilves;kalle.ilves@haaga-helia.fi"
GET teacher:h02680
```
...
- **Neo4j** is an example of a **graph-based** NoSQL DBM
...
- The "State of Database Survey" anually studies the usage of different database technologies. Here's a few highlights from the year 2023:
  - **MongoDB** and **Redis** NoSQL DBMSs are in the **top four most widely used DBMSs** right after Postgres and MySQL
