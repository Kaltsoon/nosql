...
> [!IMPORTANT]  
> Exercise 1 👨‍💻: Read the article mentioned above. Then, take and pass the "Introduction to NoSQL database management systems" Moodle exam related to the principles of the NoSQL database management systems. If you didn't pass the exam, you can retake it as many times as necessary.
