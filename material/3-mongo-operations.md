...
Read the [Query Documents](https://www.mongodb.com/docs/manual/tutorial/query-documents/) and the [Sorting documents](https://www.geeksforgeeks.org/mongodb/mongodb-sort-method/) guides. Then, familiriaze yourself with the following query concepts:
...
3. Find the books that have more than fifteen copies. Sort the books in _ascending_ order by the number copies
...
5. Find the books written by either the author "Jane Austen" or "Aldous Huxley"
